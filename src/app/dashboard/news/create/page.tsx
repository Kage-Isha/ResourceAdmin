...
import { newsAPI, categoriesAPI } from '@/lib/api'
...
export default function CreateNewsPage() {
  ...
  const { register, handleSubmit, watch, formState: { errors } } = useForm<NewsForm>()
  ...
  const onSubmit = async (data: NewsForm) => {
    ...
    try {
      ...
      formData.append('summary', data.title) // Use title as summary
      formData.append('content', data.content)
      formData.append('status', 'published') // Always publish
  ...
  return (
    <div className="p-8">
      ...
      <div className="bg-white rounded-lg shadow p-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Create News Article</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            />
            <p className="mt-1 text-xs text-gray-500">Leave empty to publish immediately when status is set to published</p>
          </div>
